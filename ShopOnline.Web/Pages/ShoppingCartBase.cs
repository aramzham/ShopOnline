...
public class ShoppingCartBase : ComponentBase
{
    ...
    private ValueTask UpdateItemTotalPrice(CartItemDto cartItemDto)
    {
        ...
        return ManageCartItemsLocalStorageService.SaveCollection(ShoppingCartItems);
    }
    ...
    private ValueTask RemoveCartItem(int id)
    {
        var cartItemDto = GetCartItem(id);

        ShoppingCartItems.Remove(cartItemDto);

        return ManageCartItemsLocalStorageService.RemoveCollection();
    }
